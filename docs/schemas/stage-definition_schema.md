...
- [8. [Optional] Property `WfExS-backend stage definition > outputs`](#outputs)
  - [8.1. [Optional]Pattern Property `WfExS-backend stage definition > outputs > ^.+$`](#outputs_pattern1)
    ...
    - [8.1.2. [Optional] Property `WfExS-backend stage definition > outputs > ^.+$ > preferredName`](#outputs_pattern1_preferredName)
    - [8.1.3. [Optional] Property `WfExS-backend stage definition > outputs > ^.+$ > glob`](#outputs_pattern1_glob)
...
#### <a name="outputs_pattern1_preferredName"></a>8.1.2. [Optional] Property `WfExS-backend stage definition > outputs > ^.+$ > preferredName`
...
#### <a name="outputs_pattern1_glob"></a>8.1.3. [Optional] Property `WfExS-backend stage definition > outputs > ^.+$ > glob`
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2021-07-28 at 22:36:24 +0200